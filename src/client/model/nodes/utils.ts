...
export const OptionsTypes: any = {
  ...
  [PNLClasses.EM_COMPOSITION]: {
    memory_template : {type: 'string'},
    memory_fill : {type: 'string'},
    memory_capacity : {type: 'string'},
    fields: {type: 'string'},
    field_names : {type: 'string'},
    field_weights: {type: 'string'},
    learn_field_weights : {type: 'boolean'},
    learning_rate: {type: 'string'},
    normalize_field_weights : {type: 'boolean'},
    concatenate_queries : {type: 'boolean'},
    normalize_memories : {type: 'boolean'},
    softmax_gain : {type: 'string'},
    softmax_threshold : {type: 'string'},
    storage_choice : {type: 'string'},
    storage_prob : {type: 'string'},
    memory_decay_rate : {type: 'string'},
    purge_by_field_weights: {type: 'boolean'},
    enable_learning : {type: 'boolean'},
    target_fields : {type: 'string'},
    seed : {type: 'string'},
  },
  [PNLClasses.AUTODIFF_COMPOSITION]: {
    ...
    disable_learning: {type: 'boolean'},
    force_no_retain_graph: {type: 'boolean'},
    refresh_losses: {type: 'boolean'},
    synch_projection_matrices_with_torch: {type: 'string'},
    synch_node_variables_with_torch: {type: 'string'},
    synch_node_values_with_torch: {type: 'string'},
    synch_results_with_torch: {type: 'string'},
    retain_torch_trained_outputs: {type: 'string'},
    retain_torch_targets: {type: 'string'},
    retain_torch_losses: {type: 'string'},
    device: {type: 'string'},
    disable_cuda: {type: 'boolean'},
    cuda_index: {type: 'string'},
  },
  [PNLMechanisms.PROCESSING_MECH]: {
