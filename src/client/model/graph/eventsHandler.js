    ...
    switch (event.function) {
        case CallbackTypes.POSITION_CHANGED: {
            ...
            if (isDetached) {
                ...
                shouldModelUpdate = context.props.compositionOpened.getID() !== parent.getID()
            }
            modelInstance.updateModel(node, context.mousePos.x, context.mousePos.y, shouldModelUpdate);
            break;
        }
