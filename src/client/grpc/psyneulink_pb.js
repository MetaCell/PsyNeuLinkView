...
goog.exportSymbol('proto.psyneulinkviewer.ModelData', null, global);
 ...
 * @constructor
 */
proto.psyneulinkviewer.ModelData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.psyneulinkviewer.ModelData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.psyneulinkviewer.ModelData.displayName = 'proto.psyneulinkviewer.ModelData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.psyneulinkviewer.ModelData.prototype.toObject = function(opt_includeInstance) {
  return proto.psyneulinkviewer.ModelData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.psyneulinkviewer.ModelData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.psyneulinkviewer.ModelData.toObject = function(includeInstance, msg) {
  var f, obj = {
    path: jspb.Message.getFieldWithDefault(msg, 1, ""),
    modeljson: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.psyneulinkviewer.ModelData}
 */
proto.psyneulinkviewer.ModelData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.psyneulinkviewer.ModelData;
  return proto.psyneulinkviewer.ModelData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.psyneulinkviewer.ModelData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.psyneulinkviewer.ModelData}
 */
proto.psyneulinkviewer.ModelData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.psyneulinkviewer.ModelData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.psyneulinkviewer.ModelData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.psyneulinkviewer.ModelData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.psyneulinkviewer.ModelData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPath();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.psyneulinkviewer.ModelData.prototype.getPath = function() {
...
/**
 * @param {string} value
 * @return {!proto.psyneulinkviewer.ModelData} returns this
 */
proto.psyneulinkviewer.ModelData.prototype.setPath = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string modelJson = 2;
 * @return {string}
 */
proto.psyneulinkviewer.ModelData.prototype.getModeljson = function() {
 ...
 * @return {!proto.psyneulinkviewer.ModelData} returns this
 */
proto.psyneulinkviewer.ModelData.prototype.setModeljson = function(value) {
